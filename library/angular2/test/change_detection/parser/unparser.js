'use strict';var ast_1 = require('angular2/src/change_detection/parser/ast');
...
var Unparser = (function () {
    ...
    Unparser.prototype.visitAccessMember = function (ast) {
        this._visit(ast.receiver);
        this._expression += ast.receiver instanceof ast_1.ImplicitReceiver ? "" + ast.name : "." + ast.name;
    };
    Unparser.prototype.visitAssignment = function (ast) {
    ...
    Unparser.prototype.visitKeyedAccess = function (ast) {
        this._visit(ast.obj);
        this._expression += '[';
        this._visit(ast.key);
        this._expression += ']';
    ...
    Unparser.prototype.visitSafeAccessMember = function (ast) {
        this._visit(ast.receiver);
        this._expression += "?." + ast.name;
    };
