...
function main() {
    function r(_a) {
        ...
        return new proto_record_1.ProtoRecord(mode, name, null, [], null, 0, directiveIndex, 0, null, null, lastInBinding, false, argumentToPureFunction, referencedBySelf);
    }
    test_lib_1.describe("ProtoRecord", function () {
        test_lib_1.describe('shouldBeChecked', function () {
            test_lib_1.it('should be true for pure functions', function () {
                test_lib_1.expect(r({ mode: proto_record_1.RecordType.COLLECTION_LITERAL }).shouldBeChecked()).toBeTruthy();
            });
