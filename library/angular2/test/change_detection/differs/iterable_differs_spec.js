...
var iterable_differs_1 = require('angular2/src/change_detection/differs/iterable_differs');
...
function main() {
    test_lib_1.describe('IterableDiffers', function () {
        ...
        test_lib_1.beforeEach(function () {
            factory1 = new test_lib_1.SpyIterableDifferFactory();
            factory2 = new test_lib_1.SpyIterableDifferFactory();
            factory3 = new test_lib_1.SpyIterableDifferFactory();
        });
        ...
        test_lib_1.describe(".extend()", function () {
            test_lib_1.it('should throw if calling extend when creating root injector', function () {
                var injector = di_1.Injector.resolveAndCreate([iterable_differs_1.IterableDiffers.extend([])]);
            ...
            test_lib_1.it('should extend di-inherited diffesr', function () {
                ...
                var injector = di_1.Injector.resolveAndCreate([di_1.bind(iterable_differs_1.IterableDiffers).toValue(parent)]);
