import { ChangeDetectorDefinition, Locals } from 'angular2/src/change_detection/change_detection';
export declare var PROP_NAME: string;
/**
 ...
 */
export declare function getAllDefinitions(): List<TestDefinition>;
