...
var async_pipe_1 = require('angular2/src/change_detection/pipes/async_pipe');
    ...
    test_lib_1.describe("AsyncPipe", function () {
        test_lib_1.describe('Observable', function () {
            ...
            test_lib_1.beforeEach(function () {
                ...
                ref = new test_lib_1.SpyChangeDetectorRef();
                pipe = new async_pipe_1.AsyncPipe(ref);
            });
        ...
        test_lib_1.describe('null', function () {
            test_lib_1.it('should return null when given null', function () {
                var pipe = new async_pipe_1.AsyncPipe(null);
