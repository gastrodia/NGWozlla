...
var number_pipe_1 = require('angular2/src/change_detection/pipes/number_pipe');
function main() {
    test_lib_1.describe("DecimalPipe", function () {
        var pipe;
        test_lib_1.beforeEach(function () { pipe = new number_pipe_1.DecimalPipe(); });
    ...
    test_lib_1.describe("PercentPipe", function () {
        var pipe;
        test_lib_1.beforeEach(function () { pipe = new number_pipe_1.PercentPipe(); });
        test_lib_1.describe("transform", function () {
            test_lib_1.it('should return correct value for numbers', function () {
    ...
    test_lib_1.describe("CurrencyPipe", function () {
        var pipe;
        test_lib_1.beforeEach(function () { pipe = new number_pipe_1.CurrencyPipe(); });
        test_lib_1.describe("transform", function () {
            test_lib_1.it('should return correct value for numbers', function () {
