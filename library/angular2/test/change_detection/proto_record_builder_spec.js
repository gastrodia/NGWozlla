...
var binding_record_1 = require('angular2/src/change_detection/binding_record');
...
function main() {
    test_lib_1.describe("ProtoRecordBuilder", function () {
        test_lib_1.it('should set argumentToPureFunction flag', test_lib_1.inject([parser_1.Parser], function (p) {
            ...
            builder.add(binding_record_1.BindingRecord.createForElementProperty(ast, 0, "property"), []);
