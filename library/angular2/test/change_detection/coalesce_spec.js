...
var directive_record_1 = require('angular2/src/change_detection/directive_record');
function main() {
    function r(funcOrValue, args, contextIndex, selfIndex, _a) {
        ...
        if (lang_1.isBlank(mode))
            mode = proto_record_1.RecordType.PROPERTY;
        ...
        return new proto_record_1.ProtoRecord(mode, name, funcOrValue, args, null, contextIndex, directiveIndex, selfIndex, null, null, lastInBinding, false, argumentToPureFunction, false);
    }
    test_lib_1.describe("change detection - coalesce", function () {
        ...
        test_lib_1.it("should replace duplicate terminal records with self records", function () {
            ...
            test_lib_1.expect(rs[1]).toEqual(new proto_record_1.ProtoRecord(proto_record_1.RecordType.SELF, "self", null, [], null, 1, null, 2, null, null, true, false, false, false));
        });
        ...
        test_lib_1.it("should not coalesce directive lifecycle records", function () {
            var rs = coalesce_1.coalesce([
                r("onCheck", [], 0, 1, { mode: proto_record_1.RecordType.DIRECTIVE_LIFECYCLE }),
                r("onCheck", [], 0, 1, { mode: proto_record_1.RecordType.DIRECTIVE_LIFECYCLE })
            ]);
