...
var shadow_css_1 = require('angular2/src/render/dom/compiler/shadow_css');
...
function main() {
    test_lib_1.describe('ShadowCss', function () {
        ...
        if (lang_1.isPresent(dom_adapter_1.DOM.defaultDoc().body.style) &&
            lang_1.isPresent(dom_adapter_1.DOM.defaultDoc().body.style.animationName)) {
