...
function main() {
    test_lib_1.describe('Location', function () {
        ...
        function makeLocation(baseHref, binding) {
            ...
            var injector = di_1.Injector.resolveAndCreate([location_1.Location, di_1.bind(location_strategy_1.LocationStrategy).toValue(locationStrategy), binding]);
        ...
        test_lib_1.it('should use optional base href param', function () {
            var location = makeLocation('/', di_1.bind(location_1.appBaseHrefToken).toValue('/my/custom/href'));
            location.go('user/btford');
