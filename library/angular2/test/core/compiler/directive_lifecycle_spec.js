        ...
        test_lib_1.describe('lifecycle', function () {
            ...
            test_lib_1.describe("onChange", function () {
                ...
                test_lib_1.it("should be true when the lifecycle includes onChange", function () {
                    test_lib_1.expect(metadata(DirectiveNoHooks, new annotations_1.Directive({ lifecycle: [annotations_1.LifecycleEvent.onChange] }))
                        .callOnChange)
                        .toBe(true);
                });
            ...
            test_lib_1.describe("onDestroy", function () {
                ...
                test_lib_1.it("should be true when the lifecycle includes onDestroy", function () {
                    test_lib_1.expect(metadata(DirectiveNoHooks, new annotations_1.Directive({ lifecycle: [annotations_1.LifecycleEvent.onDestroy] }))
                        .callOnDestroy)
                        .toBe(true);
                });
            ...
            test_lib_1.describe("onInit", function () {
                ...
                test_lib_1.it("should be true when the lifecycle includes onDestroy", function () {
                    test_lib_1.expect(metadata(DirectiveNoHooks, new annotations_1.Directive({ lifecycle: [annotations_1.LifecycleEvent.onInit] }))
                        .callOnInit)
                        .toBe(true);
                });
            ...
            test_lib_1.describe("onCheck", function () {
                ...
                test_lib_1.it("should be true when the lifecycle includes onCheck", function () {
                    test_lib_1.expect(metadata(DirectiveNoHooks, new annotations_1.Directive({ lifecycle: [annotations_1.LifecycleEvent.onCheck] }))
                        .callOnCheck)
                        .toBe(true);
                });
            ...
            test_lib_1.describe("onAllChangesDone", function () {
                ...
                test_lib_1.it("should be true when the lifecycle includes onAllChangesDone", function () {
                    test_lib_1.expect(metadata(DirectiveNoHooks, new annotations_1.Directive({ lifecycle: [annotations_1.LifecycleEvent.onAllChangesDone] }))
